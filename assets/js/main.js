...
function check() {
  ...
  var text1 = document.getElementsByClassName("price");
  var text2 = document.getElementsByClassName("price2");
  var text3 = document.getElementsByClassName("m_price2");
  var text4 = document.getElementsByClassName("m_price");
  var text5 = document.getElementsByClassName("dis_on");
